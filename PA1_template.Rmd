...
The 5-minute interval number `r maximum[,1]`, on average across all the days in the dataset, contains the maximum number of daily average steps `r maximum[,2]`.
